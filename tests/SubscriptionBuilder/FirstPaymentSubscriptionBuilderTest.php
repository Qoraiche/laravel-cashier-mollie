...
use Cashier\Mollie\SubscriptionBuilder\RedirectToCheckoutResponse;
...
class FirstPaymentSubscriptionBuilderTest extends BaseTestCase
{
    ...
    public function createsAFirstPaymentForSubscription()
    {
        ...
        $this->assertEquals('Cashier\\Mollie\\FirstPayment\\Actions\\StartSubscription', $localPayment->first_payment_actions[0]->handler);
        ...
        $this->assertEquals('Cashier\\Mollie\\FirstPayment\\Actions\\AddGenericOrderItem', $localPayment->first_payment_actions[1]->handler);
