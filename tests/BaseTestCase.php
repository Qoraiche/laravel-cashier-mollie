...
use Cashier\Mollie\Coupon\FixedDiscountHandler;
use Cashier\Mollie\Plan\AdvancedIntervalGenerator;
use Cashier\Mollie\Tests\Database\Migrations\CreateUsersTable;
...
abstract class BaseTestCase extends TestCase
{
    ...
    {
        return ['Cashier\Mollie\CashierServiceProvider'];
    }
    ...
    {
        config(['cashier.billable_model' => 'Cashier\Mollie\Tests\Fixtures\User']);
