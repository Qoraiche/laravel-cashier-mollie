...
use Cashier\Mollie\Events\SubscriptionCancelled;
...
use Cashier\Mollie\Order\Contracts\PreprocessesOrderItems;
...
use Cashier\Mollie\Types\SubscriptionCancellationReason;
use LogicException;
use Money\Currency;
use Money\Money;
...
class Subscription extends Model implements InteractsWithOrderItems, PreprocessesOrderItems, AcceptsCoupons, IsRefundable
{
     ...
     * @param  \Cashier\Mollie\Plan\Contracts\Plan  $plan
     ...
     *
     * @return \Cashier\Mollie\Plan\Plan
     */
     ...
     * @param  int  $count
     * @param  bool  $invoiceNow
     * @return \Cashier\Mollie\Subscription
     *
     * @throws \Throwable
     */
    ...
    protected function reimbursableAmount()
    {
        ...
        /** @var \Cashier\Mollie\Refunds\RefundItemCollection $refundItems */
    ...
    /**
     * @param  \Carbon\Carbon|null  $now
     * @return null|\Cashier\Mollie\Order\OrderItem
     */
