...
use Cashier\Mollie\SubscriptionBuilder\Contracts\SubscriptionConfigurator;
...
class StartSubscription extends BaseAction implements SubscriptionConfigurator
{
    ...
    /** @var null|\Cashier\Mollie\SubscriptionBuilder\MandatedSubscriptionBuilder */
    protected $builder;
    ...
    /**
     * @return \Cashier\Mollie\Coupon\Coupon|null
     */
     ...
     *
     * @throws \Throwable|\Cashier\Mollie\Exceptions\PlanNotFoundException
     */
