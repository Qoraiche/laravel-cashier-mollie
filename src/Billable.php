...
use Cashier\Mollie\Charge\ManagesCharges;
...
use Cashier\Mollie\Traits\PopulatesMollieCustomerFields;
use Cashier\Mollie\UpdatePaymentMethod\UpdatePaymentMethodBuilder;
...
trait Billable
{
     ...
     * @return \Cashier\Mollie\Subscription|null
     */
     ...
     * @return \Cashier\Mollie\SubscriptionBuilder\Contracts\SubscriptionBuilder
     *
     ...
     *
     * @throws \Cashier\Mollie\Exceptions\PlanNotFoundException
     * @throws \Throwable|\Cashier\Mollie\Exceptions\InvalidMandateException
     */
    ...
    /**
     * @return \Cashier\Mollie\Billable
     */
    ...
    /**
     * @return \Cashier\Mollie\UpdatePaymentMethod\UpdatePaymentMethodBuilder
     */
     ...
     *
     * @param $orderNumber
     * @return \Cashier\Mollie\Order\Invoice|null
     *
